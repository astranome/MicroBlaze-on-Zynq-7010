...
{
  file="xsim.ini"
  lib_map_path="H:/Xilinx/Vivado/2018.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb blaze.wdb xsim.dir)
